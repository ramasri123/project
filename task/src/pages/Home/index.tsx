...
const task = () => {
    return(
        <div className="full-screen bg-zinc-200 bg-scroll">
            ...
            <div className="flex ">
            <div className="w-80 ml-5 mr-2 mt-5 ring-offset-0 ring ring-slate-800">
                ...
                <div className="min-h-20 w-50 ml-60 mr-6 mt-5">
                <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1696852847761-574450.jpeg"/></div>
                </div>
           ...
           <div className="flex mt-6">
            ...
            <div className="space-between ml-20 ">
            ...
            <div className="space-between ml-20 ">
            <h1 className="font-semibold text-black text-2xl ">Social links</h1><br/></div>
            </div>
            </div>
    )
};
