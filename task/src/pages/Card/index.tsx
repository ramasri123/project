...
const task = () => {
    return(
        <div>
            <div className="flex">
                <div className="max-w-sm mx-auto flex-1 text-center m-4 bg-rose-300 p-10 rounded-lg shadow-md overflow-hidden">
                <h1 className="font-semibold text-black-100">card1</h1>
                </div>
                <div className="max-w-sm mx-auto flex-1 text-center  m-4 bg-blue-300 p-50 rounded-lg shadow-md overflow-hidden">
